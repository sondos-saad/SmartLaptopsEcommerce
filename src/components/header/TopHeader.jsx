  ...
  return (
    <div className="top_header w-[95%] md:w-[80%] m-auto pt-2">
        <div className="container flex items-center justify-between py-0 ">
            ...
            <form action='' className="search_box border border-blue-400 rounded-full w-50 md:w-125 flex justify-between items-center">
            ...
            <div className="header_icons flex items-center gap-4">
                <div className="icon flex items-center cursor-pointer">
                    ...
                    <span className="count -mt-4 -ml-2 bg-red-800 text-white p-1 rounded-full text-[12px] w-5 h-5 flex justify-center items-center ">0</span>
                </div>
                <div className="icon flex items-center cursor-pointer">
